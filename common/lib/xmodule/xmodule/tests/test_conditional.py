...
from lms.djangoapps.courseware.access import _visible_to_nonstaff_users
...
class ConditionalFactory(object):
    ...
    def create(system, source_is_error_module=False, source_visible_to_staff_only=False):
        ...
        system.get_module = lambda desc: desc if _visible_to_nonstaff_users(desc) else None
